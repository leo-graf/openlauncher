...
public class LauncherAction {
    ...
    public static ActionItem[] actionItems = new ActionItem[]{
            ...
            new ActionItem(Action.DeviceSettings, resources.getString(R.string.minibar_4), R.drawable.ic_settings_launcher_24dp),
            new ActionItem(Action.LauncherSettings, resources.getString(R.string.minibar_5), R.drawable.ic_build_black_24dp),
